...
urlpatterns = [
    ...
    # Monthly report
    path("building/<int:pk>/list-report-monthly/", views.BuildingMonthlyReportListView , name= "building-monthly-report"),
    # path("list-report-monthly/", views.MonthlyReportListView, name= "list-monthly-reports"),
    path("building/<int:pk>/list-report/", views.ReportListView.as_view(), name= "list-reports"),
    ...
    path("building/<int:pk>/room-report/", views.RoomReport, name = "room-reports"),
    ...
    path("register-vat/", views.VatCreateView.as_view(), name= "register-vat"),
